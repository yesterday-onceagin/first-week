...
class AddFlowNodeDialog extends React.Component {
  static propTypes = {
    show: PropTypes.bool,
    ...
    return (
      ...
      >
        <Dialog.Header closeButton>
          <Dialog.Title>新增节点</Dialog.Title>
        </Dialog.Header>
        <Dialog.Body>
          <Form className="form-horizontal"
            ...
            <ValidatedInput type="textarea"
              label={<span><i className="required">&nbsp;</i>节点描述</span>}
              autoComplete="off"
              name="description"
              rows="3"
...
export default AddFlowNodeDialog;
