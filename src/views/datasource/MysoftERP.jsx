...
const MysoftERP = createReactClass({
  ...
  getInitialState() {
    return {
      info: {
        type: DATA_SOURCE_TYPES.mysofterp.type,
        conn_str: {}
      },
      isTest: false,
      testPending: false,
  ...
  componentWillMount() {
    ...
    onChangeNavBar([{
      ...
      name: `${params.datasource_id ? '修改' : '添加'}${DATA_SOURCE_TYPES.mysofterp.name}数据源`
    }]);
  },
          ...
          <div className="database-wrap" style={this.STYLE_SHEET.formWrap} id="database-wrap">
            ...
            >
              ...
              <div className="form-group-set no-border">
                <div className="form-group-set-title">
                  {DATA_SOURCE_TYPES.mysofterp.name}接口管家应用配置
                </div>
                ...
                <div className="form-group-row form-group-row-2">
                  <ValidatedInput type="text"
                    ...
                    autoComplete="off"
                    name="app_name"
                    value={info.conn_str.app_name || ''}
                    onChange={this.handleChangeInfo.bind(this, 'conn_str', 'app_name')}
                    wrapperClassName="input-wrapper"
                    validate='required'
                    errorHelp={{
                      required: '请输入应用名称'
                  ...
                  <ValidatedInput type="text"
                    label={<span><i className="required">*</i>Host</span>}
                    autoComplete="off"
                    name="host"
                  ...
                  <ValidatedInput type="text"
                    ...
                    validate='required'
                    errorHelp={{
                      required: '请输入AccessId'
                    }} />
                  <ValidatedInput type="text"
                    label={<span><i className="required">*</i>AccessSecret</span>}
                    autoComplete="off"
                    name="access_secret"
                    value={info.conn_str.access_secret || ''}
                    onChange={this.handleChangeInfo.bind(this, 'conn_str', 'access_secret')}
                    wrapperClassName="input-wrapper"
                    validate='required'
                    errorHelp={{
                      required: '请输入AccessSecret'
                    }} />
                </div>
                <ValidatedInput type="text"
...
export default connect(stateToProps, dispatchToProps)(MysoftERP);
