...
var ResourceLoader = function () {
    ...
    _createClass(ResourceLoader, [{
        ...
        value: function xhrImage(src) {
            ...
            //                 console.log('file ok', e.target.result)
            //                 resolve(e.target.result);
            //             };
            //             reader.onerror = function (e) {
            //                 console.log('FileReader errrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr', e)
            //                 reject(e);
            //             };
            //             reader.readAsDataURL(data);
            //         }).catch(function (e) {
            //             console.log('errrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr', e)
            //             reject(e)
            //         })
            //     }).then(function (src) {
            ...
            //     });
            // } else {
            //     this.cache[src] = _loadImage(src, _this3.options.imageTimeout || 0);
            // }
            ...
            this.cache[src] = new Promise(function (resolve, reject) {
                ...
                var xhrSrc = src;
                // 如果是阿里云oss的地址进行请求
                if (/oss-cn/i.test(src)) {
                    xhrSrc = '/api/image/get?url=' + encodeURIComponent(src);
                }
                xhr.open('GET', xhrSrc);
                xhr.send();
            }).then(function (src) {
